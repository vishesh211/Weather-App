...
class MainActivity : AppCompatActivity() {
    ...
    private val mLocationCallBack = object : LocationCallback(){
        override fun onLocationResult(locationResult: LocationResult) {
            val mLastLocaiton: Location = locationResult.lastLocation

            val latitude = mLastLocaiton.latitude
            Log.i("Current Latitude", "$latitude")

            val longitude = mLastLocaiton.longitude
    ...
    private fun showRationaleDialogForPermissions(){
        AlertDialog.Builder(this)
            .setMessage("It Looks Like You Have Turned OFF Permissions Required for this Feature. It can be Enabled Under Applications Settings.")
